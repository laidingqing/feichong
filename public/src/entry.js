...
routerApp.config(function ($stateProvider, $urlRouterProvider, $httpProvider) {
    ...
    $stateProvider
        ...
        .state('dashboard.customers', { url: '/customers', templateUrl: 'views/customers.html?7', controller: controllers.CustomersCtrl })
        .state('dashboard.orders', { url: '/orders', templateUrl: 'views/orders.html?10', controller: controllers.OrdersCtrl })
